...
(function (controllers) {
    ...
    (function (bookingclient) {
        'use strict';
        var GetReservedAgentController = /** @class */ (function () {
            function GetReservedAgentController($scope, $sce, $timeout, $window, BookingService) {
                var _this = this;
                this.$scope = $scope;
                this.$sce = $sce;
                ...
                this.GetReservedItems = function () {
                    ...
                    _this.BookingService.GetAgentsReservedItems(request).then(function (result) {
                        var items = [];
            ...
            GetReservedAgentController.$inject = ['$scope', '$sce', '$timeout', '$window', 'BookingService'];
            return GetReservedAgentController;
        }());
        bookingclient.GetReservedAgentController = GetReservedAgentController;
    })(bookingclient = controllers.bookingclient || (controllers.bookingclient = {}));
})(controllers || (controllers = {}));
//# sourceMappingURL=bookingclient.getreservedagent.contoller.js.map